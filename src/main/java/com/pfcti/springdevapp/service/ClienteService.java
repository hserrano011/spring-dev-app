...
public class ClienteService {
  ...
  */
    ...
    public io.spring.guides.gs_producing_web_service.Cliente obtenerClienteSoap(int idCliente) { Cliente cliente = clienteRepository.findById(idCliente)
            .orElseThrow(() -> {
        ...
        clienteWs.setTelefono(cliente.getTelefono()); clienteWs.setPaisNacimiento(cliente.getPais());
        return clienteWs;
    }
